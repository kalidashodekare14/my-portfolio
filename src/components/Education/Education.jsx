...
const Education = () => {
    return (
        <div className='h-[110vh]  bg-[#110f17]'>
            ...
            <div>
                <div className='flex justify-center items-center space-x-5 mt-20 mb-5 '>
                    <div className='hover:bg-[#07dde12d] duration-500 transition text-white border border-[#02bfe2] w-[40%]  p-5 space-y-3 rounded-lg'>
